!(function (a) {
  const b = typeof self === 'object' && self.self === self && self || typeof global === 'object' && global.global === global && global; typeof define === 'function' && define.amd ? define(['exports'], (c) => { b.ParticleNetwork = a(b, c); }) : typeof module === 'object' && module.exports ? module.exports = a(b, {}) : b.ParticleNetwork = a(b, {});
}((a, b) => {
  const c = function (a) {
